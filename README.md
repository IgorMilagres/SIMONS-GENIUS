...
Multi Function Shield (Display de 7 segmentos, LEDs, botões e buzzer)
Funcionalidades
Jogo da memória estilo Genius utilizando sensor ultrassônico.
Geração aleatória de sequências para cada partida.
Sistema progressivo de fases com aumento gradual da dificuldade.
Exibição da fase atual no display de 7 segmentos.
Reprodução visual da sequência através dos LEDs do Shield.
Feedback sonoro utilizando o buzzer integrado.
Controle das jogadas por meio da posição da mão detectada pelo sensor ultrassônico.
Reconhecimento de quatro faixas de distância para representar diferentes comandos.
Animações de sucesso ao completar fases.
